...
export default function ClosingCTA() {
  ...
  return (
    <section ref={ref} className="bg-cream border-t border-grey-200 overflow-hidden">
          ...
          >
            <div>
              <div className="flex items-center gap-3 mb-8">
                ...
                <p className="label text-gold">Persönliche Einladung</p>
              </div>

              <h2 className="font-display text-[clamp(3rem,7vw,6rem)] font-light text-navy leading-[0.95] mb-8">
                Lassen Sie uns<br />
                <span className="text-gold">miteinander sprechen.</span>
              </h2>
            ...
            <div className="mt-16 grid grid-cols-3 gap-4">
              {[
                ...
                <div key={s.step} className="border-t-2 border-gold pt-4">
                  <p className="font-display text-2xl font-light text-navy/30 mb-2">{s.step}</p>
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 right-8">
              <div className="bg-cream/95 p-6 border-l-4 border-gold">
                <p className="label text-gold mb-2">Ihr nächster Schritt</p>
